...
$conn=mysqli_connect($servername,$username,$password,$database);
    ...
    if($_SESSION['login_user']=="Saiprasad")
    {
        $PRN=$_GET['PRN'];
    }
    else{
            ...
            <div class="container-fluid">
                <ul class="nav nav-pills">
                    ...
                    <li class="nav-item mx-2">
                        <a class="nav-link active" aria-current="page" href="UpdateP.php?PRN=$prn">Update Profile</a>
                    </li>
                </ul>
                <div class=" my-2 my-lg-0">
                    <ul class="nav nav-pills">
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="app/login.php">Chat</a>
                        </li>
                        <li class="nav-item mx-4">
                            <a class="nav-link active " aria-current="page" href="new_assignment.php">Assignment</a>
                        </li>
                        <li class="nav-item mx-4">
